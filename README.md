...
La aplicacion se encuentra desplegada dentro de un contenedor de docker [documento](https://github.com/JohannCepeda16/AREP-Lab4/blob/main/resources/docker.PNG)
